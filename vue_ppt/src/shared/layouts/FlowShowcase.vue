...
.carousel { position: relative; width: 100%; max-width: 1100px; height: clamp(380px, 58vh, 480px); margin-top: clamp(1.5rem, 4vw, 2.2rem); perspective: 1400px; z-index: 1; }
...
@media print {
  /* Keep layout visuals similar to screen */
  .carousel { height: auto; perspective: none; }
  .carousel::before { display: none; }
  /* Render each panel like active, one per page */

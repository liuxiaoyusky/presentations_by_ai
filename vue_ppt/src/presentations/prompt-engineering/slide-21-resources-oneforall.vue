...
const title = '4.1 One For All'
const table = `| Service | Model | Website | Access | Notes |
|---------|-------|---------|--------|-------|
...
| **Perplexity** | Perplexity Pro | url(https://perplexity.ai) | Free/Paid | 💡 PayPal subscription gives 1 year membership |`
</script>
